...
public struct ConnectOpts {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(headers: [String: String]? = nil, body: String? = nil, method: Method? = nil, timeoutMs: UInt64 = UInt64(30000)) {
...
public struct FfiConverterTypeLiveSocketError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> LiveSocketError {
        ...
        case 11: return try .ConnectionError(
                FfiConverterString.read(from: &buf)
            )
        case 12: return .PhoenixSessionMissing
        case 13: return .PhoenixStaticMissing
        case 14: return .PhoenixMainMissing
        case 15: return .NoHostInUrl
        case 16: return .NoUploadToken
        case 17: return .NoLiveReloadUrl
        case 18: return try .SchemeNotSupported(
                scheme: FfiConverterString.read(from: &buf)
            )
        case 19: return try .Upload(
                error: FfiConverterTypeUploadError.read(from: &buf)
            )
        case 20: return .NoDocumentInJoinPayload
        case 21: return try .DocumentMerge(
                error: FfiConverterTypeMergeError.read(from: &buf)
            )
        case 22: return try .DocumentRender(
                error: FfiConverterTypeRenderError.read(from: &buf)
            )
        case 23: return .NoInputRefInDocument
        case 24: return try .Serde(
                error: FfiConverterString.read(from: &buf)
            )
        case 25: return try .Events(
                error: FfiConverterString.read(from: &buf)
            )
        default: throw UniffiInternalError.unexpectedEnumCase
        }
